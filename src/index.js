// The HTML content of the frontend, escaped and stored in a variable.
...
<head>
    ...
    <style>
        ...
        /* Custom scrollbar for YouTube look */
...
export default {
  async fetch(request, env, ctx) {
    ...
    // Handle the /start-chat API endpoint
    if (url.pathname === '/start-chat' && request.method === 'POST') {
      try {
    ...
    if (url.pathname === '/chat' && request.method === 'POST') {
       try {
        ...
        // Pass the response through, including headers
